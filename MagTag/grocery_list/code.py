...
TSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTuSk8EVG0_ElluyS22gaqiDuaF8HzJcoDZJpw3zvKeabd9y6G21sXJIjlUeVkPxLHuboU_g7tLpOmh/pub?output=tsv'
...
while True:
    try:
        ...
        if GROCERY_LIST != PRIOR_LIST:

            # Set the day-of-week label at top
            MAGTAG.set_text('test', auto_refresh=False)
            ...
            MAGTAG.set_text(GROCERY_LIST, 1) # Update list, refresh display
            print('2')
            #MAGTAG.set_text(TASK_LIST, 1) # Update list, refresh display
            PRIOR_LIST = GROCERY_LIST        # Save list state for next pass
